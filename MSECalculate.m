function [ MSETrain ] = MSECalculate(xmin,stpx,xmax,stepx,Fcentx,RuleBaseSugenoFinal,Wfire)
...
%   numpoint=numpoint*10;          
        ...
        %%%%%%%% location of yhat and call zcoa
         if(flag1==0 && flag2==0)%%%%%ZCOA22
          [yhat,Wfire]=ZCOA22(num11,num12,num21,num22,mutx11,mutx12,mutx21,mutx22,RuleBaseSugenoFinal,Wfire);
         end
         if(flag1==0 && flag2==1)%%%%%ZCOA23
          [yhat,Wfire]=ZCOA23(num11,num12,num21,num22,num23,mutx11,mutx12,mutx21,mutx22,mutx23,RuleBaseSugenoFinal,Wfire);
         end
         if(flag1==1 && flag2==0)%%%%%ZCOA32
          [yhat,Wfire]=ZCOA32(num11,num12,num13,num21,num22,mutx11,mutx12,mutx13,mutx21,mutx22,RuleBaseSugenoFinal,Wfire);
         end
         if(flag1==1 && flag2==1)%%%%%ZCOA33
          [yhat,Wfire]=ZCOA33(num11,num12,num13,num21,num22,num23,mutx11,mutx12,mutx13,mutx21,mutx22,mutx23,RuleBaseSugenoFinal,Wfire);
         end
...
%          end 
            ...
            m=m*20;
            n=m;%% Number of iteration for parameter MSE
%          if(flag1==0 && flag2==1)%%%%%ZCOA23
%           [yhat,Wfire]=ZCOA23(num11,num12,num21,num22,num23,mutx11,mutx12,mutx21,mutx22,mutx23,RuleBaseSugenoFinal,Wfire);
%          end
%          if(flag1==1 && flag2==0)%%%%%ZCOA32
...
%          YhatTrain(indexi,indexj) =yhat;
      ...
      MSETrain=(sum(sum((YhatTrain-YtrueTrain).^2)))/(2*n); 
